          ...
          <div class="container-fluid">
            <div class="row">
              <div
                ...
                "
              >
                <h3 style="color: #fff; font-size: 30px">Terms and conditions</h3>
              </div>
              <!-- .pogoSlider -->
            </div>
          </div>
        ...
        <section class="text-center">
          <div>
            ...
            <p>
              ...
              person log on this website and compliant to the CompanyвЂ™s terms and conditions. "The
              ...
              meeting the ClientвЂ™s needs in respect of provision of the CompanyвЂ™s stated
              services, in accordance with and subject to, prevailing law of Netherlands. Any use of
              the above terminology or other words in the singular, plural, capitalization and/or
            ...
            <p>
              ...
              <span class="server-name"></span>. All intellectual property rights are reserved. You
              may access this from <span class="server-name"></span> for your own personal use
            ...
            <p>
              ...
              of <span class="server-name"></span>,its agents and/or affiliates. Comments reflect
              the views and opinions of the person who post their views and opinions. To the extent
              permitted by applicable laws, <span class="server-name"></span> shall not be liable
            ...
            <p>
              ...
              remove any Comments which can be considered inappropriate, offensive or causes breach
            ...
            <p>
              ...
              and/or services; and (c) fits within the context of the linking partyвЂ™s site.
            </p>
            ...
            <p>
              ...
              We also reserve the right to amen these terms and conditions and itвЂ™s linking policy
